...
draw_score = None
calculate_pipe_speed = None

async def init_game():
    global screen, clock, bird, pipes, cityscape, donkey_kong, weather_system
    global leaderboard, winning_cutscene, death_cutscene, luigi_battle
    global game_state, countdown_start, last_pipe_time, score
    global current_pipe_speed, speed_level, player_name, name_input_active
    global power_ups, enemies, fireballs, NAME_INPUT_BOX
    global jump_sound, score_sound, collision_sound, game_over_sound
    global power_pipe_sound, lightning_sound, rain_sound
    global check_collision, draw_score, calculate_pipe_speed
    ...
    from flappy_bird import Bird, Pipe, Cityscape, WeatherSystem, Leaderboard, PowerUp, Enemy, Fireball
